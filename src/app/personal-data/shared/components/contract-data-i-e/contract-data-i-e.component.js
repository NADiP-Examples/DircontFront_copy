...
var ContractDataIEComponent = (function () {
    function ContractDataIEComponent(parentForm) {
        this.parentForm = parentForm;
        this.MASKS = global_data_1.MASKS;
    }
    ContractDataIEComponent.prototype.ngOnInit = function () {
    };
    ContractDataIEComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
        this.controls.forEach(function (control) {
            _this.parentForm.addControl(control);
        });
    };
    ContractDataIEComponent.prototype.ngOnDestroy = function () {
        var _this = this;
        this.controls.forEach(function (control) {
            _this.parentForm.removeControl(control);
        });
    };
    ContractDataIEComponent.prototype.duplicateFIO = function () {
    ...
    ContractDataIEComponent.prototype.duplicateAddress = function () {
    ...
    ], ContractDataIEComponent.prototype, "controls", void 0);
    __decorate([
        core_1.Input()
    ], ContractDataIEComponent.prototype, "personal_data", void 0);
    __decorate([
        core_1.Input()
    ], ContractDataIEComponent.prototype, "form_view", void 0);
    ContractDataIEComponent = __decorate([
        core_1.Component({
    ...
    return ContractDataIEComponent;
}());
exports.ContractDataIEComponent = ContractDataIEComponent;
